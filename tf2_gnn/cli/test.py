...
PPI_DATA_PATH = 'D:/PycharmProject/tf2-gnn/tf2_gnn/test/test_datasets/ppi'
...
def run_from_parameters() -> None:
    data_path = RichPath.create(PPI_DATA_PATH)
    ...
    test(model, dataset, lambda msg: print(msg), quiet=False)
